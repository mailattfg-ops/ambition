...
export default function StepOne({ onNext }: { onNext: () => void }) {
  ...
  return (
    <div className="flex items-center justify-center w-full">
      <div className="w-full max-w-[960px] bg-[#FFFFFF] rounded-[20px] flex flex-col md:flex-row p-6 md:p-8 gap-8 md:gap-10 lg:gap-12 items-stretch transition-all duration-300 relative border border-slate-100 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.06)]">
        ...
        <div className="flex-1 flex flex-col justify-center w-full select-none">
          <div className="w-full flex flex-col items-start animate-fade-in">
            ...
            <div className="flex items-center gap-6 mb-8 w-full">
              <div className="relative w-[110px] h-[110px] sm:w-[130px] sm:h-[130px] select-none">
                <div className="w-full h-full rounded-[16px] overflow-hidden border border-slate-100 shadow-sm relative">
                  <Image
                ...
                <div className="absolute bottom-[-12px] sm:bottom-[-15px] left-1/2 -translate-x-1/2 w-[24px] h-[24px] sm:w-[30px] sm:h-[30px] rounded-full bg-[#4CD964] border-[3px] border-[#FFFFFF] z-10 shadow-[0_2px_8px_rgba(0,0,0,0.12)]" />
              </div>
              <div className="relative w-[110px] h-[110px] sm:w-[130px] sm:h-[130px] select-none">
                <div className="w-full h-full rounded-[16px] overflow-hidden border border-slate-100 shadow-sm relative">
                  <Image
                ...
                <div className="absolute bottom-[-12px] sm:bottom-[-15px] left-1/2 -translate-x-1/2 w-[24px] h-[24px] sm:w-[30px] sm:h-[30px] rounded-full bg-[#FF3B30] border-[3px] border-[#FFFFFF] z-10 shadow-[0_2px_8px_rgba(0,0,0,0.12)]" />
              </div>
            </div>
