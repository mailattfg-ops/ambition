...
function MarqueeImage({ src, alt }: MarqueeImageProps) {
  return (
    <div className="relative w-[342px] h-[440px] rounded-[20px] overflow-hidden shrink-0 bg-gray-50 border border-gray-100">
      <Image
        src={src}
        alt={alt}
        fill
...
export default function InActionSection() {
  ...
  return (
    <section className="relative w-full flex flex-col items-center pt-24 pb-32 bg-[#FFFFFF] overflow-hidden select-none">
      ...
      <div className="relative flex h-[700px] w-full max-w-[1140px] px-6 md:px-12 xl:px-0 flex-row gap-6 items-center justify-center overflow-hidden">
        
        {/* Left Column: Normal Scroll Speed (20s) */}
        <div className="flex flex-col h-full w-[342px] overflow-hidden">
        ...
        {/* Middle Column: Reverse Scroll Speed (20s) */}
        <div className="flex flex-col h-full w-[342px] overflow-hidden">
        ...
        <div className="absolute inset-x-0 top-0 h-[180px] bg-gradient-to-b from-[#FFFFFF] via-[#FFFFFF]/80 to-transparent z-10 pointer-events-none" />
        <div className="absolute inset-x-0 bottom-0 h-[180px] bg-gradient-to-t from-[#FFFFFF] via-[#FFFFFF]/80 to-transparent z-10 pointer-events-none" />
      </div>
