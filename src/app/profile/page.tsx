  ...
  return (
    <div className={`min-h-screen w-full max-w-full overflow-x-hidden flex flex-col bg-[#FFFFFF] relative select-none ${inter.className}`}>
      ...
      <header className="w-full bg-transparent relative z-10 border-b border-white/20 pb-4">
        <div className="max-w-[1600px] w-full mx-auto px-6 sm:px-12 md:px-20 h-[80px] flex items-center justify-between mt-4">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/generate"
              className="flex items-center justify-center bg-[#000000] rounded-[25.84px] w-[245px] h-[41.35px] pt-[10.34px] pr-[21.71px] pb-[10.34px] pl-[21.71px] gap-[10.34px] hover:bg-black/90 active:scale-98 transition-all"
            >
              <Image
      ...
      <main className="flex-1 pt-24 pb-16 px-6 sm:px-12 md:px-20 max-w-[1600px] w-full mx-auto">
        ...
        <div className="w-full flex flex-col select-none border-b border-[#E2E8F0] pb-6">
          <div className="flex items-center gap-12 sm:gap-16">
            <button
              onClick={() => setActiveTab("orders")}
              className={`font-sans font-semibold text-[48px] leading-[100%] tracking-[-0.04em] cursor-pointer transition-all duration-300 relative ${
        ...
        <div className="mt-20 md:mt-24 w-full animate-fade-in duration-300">
          ...
          {activeTab === "orders" && (
            ...
            <div className="flex flex-col xl:flex-row gap-8 w-full justify-center xl:justify-start items-center xl:items-start">
              ...
              {/* Order Card 1 */}
              <div className="bg-[#FFFFFF] border border-[#BCBCBC] rounded-[37px] w-[677px] shrink-0 h-[369px] p-8 flex flex-row justify-between items-center gap-8 shadow-[0_10px_40px_rgba(0,0,0,0.015)]">
                {/* Left Card content details */}
                <div className="flex-1 flex flex-col justify-between h-full w-full py-1">
                  <div className="w-full">
                    <h3 className="font-sans font-bold text-[24px] tracking-[-0.03em] text-[#101828] leading-none">
                      Wall poster with frame
                    </h3>
                    <p className="font-sans font-normal text-[15px] tracking-[-0.02em] text-[#667085] mt-2">
                      Perfect for the walls
                    </p>
                    <h4 className="font-sans font-bold text-[32px] text-[#000000] tracking-[-0.04em] mt-5 leading-none">
                      ₹299
                    </h4>
                  </div>
                  ...
                  <div className="w-full pr-4 mt-4">
                    <div className="flex items-center w-full gap-2">
                      ...
                      <div className="flex items-center flex-1">
                        <div className="w-[14px] h-[14px] rounded-full bg-[#561DFF] shrink-0" />
                        <div className="flex-1 h-[4px] bg-[#561DFF]" />
                        <div className="w-[14px] h-[14px] rounded-full bg-[#561DFF] shrink-0" />
                      </div>
                      
                      {/* Inactive dotted segment */}
                      <div className="flex items-center gap-3 px-2">
                        <div className="w-[8px] h-[8px] rounded-full bg-[#E2E8F0]" />
                        <div className="w-[8px] h-[8px] rounded-full bg-[#E2E8F0]" />
                        <div className="w-[8px] h-[8px] rounded-full bg-[#E2E8F0]" />
                      </div>
                      
                      {/* Inactive destination dot */}
                      <div className="w-[14px] h-[14px] rounded-full bg-[#D1D5DB] shrink-0" />
                    </div>
                    {/* Progress Labels */}
                    <div className="flex justify-between w-full mt-2.5 select-none">
                      <span className="font-sans font-semibold text-[13px] text-[#000000]">
                        Shipped
                      </span>
                      <span className="font-sans font-semibold text-[13px] text-[#000000]">
                        Destination
                  ...
                  <div className="bg-[#000000] text-[#FFFFFF] font-sans font-semibold text-[15px] tracking-[-0.03em] rounded-[18px] h-[54px] flex items-center justify-center w-full text-center select-none shadow-sm cursor-default mt-4 shrink-0">
                    Expected delivery : May 14, Thursday
                  </div>
                </div>

                {/* Right Card Mockup thumbnail */}
                <div className="relative w-full sm:w-[288px] h-[305px] shrink-0 overflow-hidden rounded-[24px] shadow-sm">
                  <Image
          ...
          {activeTab === "credits" && (
            ...
            <div className="w-full bg-[#FAFAFA] border border-[#A7A7A7] rounded-[31.43px] px-8 py-10 flex items-center justify-center overflow-visible">
              <div className="flex flex-col lg:flex-row items-center lg:items-end justify-center gap-6 w-full select-none">

                {/* Plan 1: Intro — 280px × 467px */}
                <div className="bg-transparent flex flex-col justify-between h-auto min-h-[467px] w-[280px] p-8 rounded-[31.43px]">
                  <div className="flex flex-col gap-4">
                    <div className="flex items-baseline gap-1 select-none">
                      <span className="font-sans font-bold text-[36px] tracking-[-0.04em] text-[#0f172a]">
                        $20
                      </span>
                      <span className="font-sans font-medium text-[14px] text-[#64748B]">
                        /month
                      </span>
                    </div>

                    <div className="flex flex-col gap-1 items-start mt-1">
                      <h4 className="font-sans font-bold text-[22px] text-[#0f172a] tracking-tight">
                        Intro
                      </h4>
                      <p className="font-sans font-medium text-[14px] leading-[145%] text-[#64748B] text-left">
                  ...
                  <button 
                    className="bg-[#E8E8E8] text-[#334155] mt-auto shrink-0 mx-auto w-[250px] h-[54px] flex items-center justify-center rounded-[29px] font-black text-[18.13px] leading-none text-center tracking-[0px]"
                ...
                <div
                  className="relative rounded-[31.43px] p-8 flex flex-col justify-between w-[353px] h-auto min-h-[580px] shrink-0"
                  style={{
                    background: "#561DFF",
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-[31.43px] pointer-events-none overflow-hidden opacity-10">
                  ...
                  <div className="absolute top-6 right-6">
                    <span className="bg-[#7B6EF6] text-white text-[11px] font-sans font-bold uppercase tracking-widest py-[5px] px-[16px] rounded-full whitespace-nowrap select-none">
                      MOST POPULAR
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col gap-4 pt-8">
                    <div className="flex items-baseline gap-1 select-none text-white">
                      <span className="font-sans font-bold text-[42px] tracking-[-0.04em]">
                        $100
                      </span>
                      <span className="font-sans font-medium text-[14px] opacity-80">
                        /month
                      </span>
                    </div>

                    <div className="flex flex-col gap-1 items-start mt-1">
                      <h4 className="font-sans font-bold text-[26px] text-white tracking-tight">
                        Pro
                      </h4>
                      <p className="font-sans font-medium text-[14px] leading-[145%] text-white opacity-80 text-left">
                        For most businesses that want to optimize web queries
                      </p>
                    </div>

                    {/* Features Checklist — Pro card: white rounded square, white tick */}
                    <div className="flex flex-col gap-3 mt-4 mb-6 w-full">
                      {["All limited links","Own analytics platform","Chat support","Optimize hashtags","Unlimited users"].map((item, idx) => (
                        <div key={idx} className="flex items-center gap-3 text-left">
                          {/* Figma: 24.18×24.18 rounded circle, path color #FFFFFF */}
                          <span
                            className="shrink-0 flex items-center justify-center rounded-full"
                          ...
                          <span className="font-sans font-medium text-[14px] text-white tracking-tight select-none">{item}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <button 
                    className="bg-[#000000] text-white mt-auto shrink-0 mx-auto w-[250px] h-[54px] flex items-center justify-center rounded-[29px] font-black text-[18.13px] leading-none text-center tracking-[0px]"
                    style={{ fontFamily: 'Avenir, sans-serif' }}
                  >
                    Choose plan
                  </button>
